                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Edit Penghuni</h3>
                            </div>
                            <form role="form" action="{{ route('penghuni.update', $data->id) }}" name="form"
                                ...
                                <div class="card-body">
                                    ...
                                    <p style="color:red">*kosongi passoword apabila tidak ingin merubah</p>
                                </div>
