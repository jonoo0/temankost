                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: center"> <a href="#"
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a class="nav-link" id="edit-data" href="{{ route('penghuni.edit', $dt->id) }}">Edit</a></li>
                                                        {{-- <li><a  href="#" class="nav-link" id="delete-data"  data-id={{ $dt->id }}
                                                            data-name={{ $dt->name }} data-toggle="modal" data-target="#deleteModal"  >Delete</a></li> --}}
                                                        <li> <a href="#" class="nav-link" id="delete-data" data-id={{ $dt->id }}
                                                                data-name={{ $dt->name }}data-toggle="modal" data-target="#deleteModal">Delete</a>
                                                        </li>
                                                    </ul>
                                                </td>
                                            </tr>
